...
I18N.register('id', {
  ...
  info_androidid_msg: 'Membuat aplikasi pada profil perangkat ini membaca ANDROID_ID palsu (identifier dari Settings.Secure). 16 karakter heksa. Diterapkan tanpa reboot dan modul dibongkar sebelum aplikasi berjalan, sehingga tidak ada jejak COPG di memori aplikasi. Kosongkan untuk memakai ID asli. Catatan: aplikasi yang gigih masih bisa membaca ID asli lewat cara lain — ini hanya mengubah pencarian Settings standar.',
