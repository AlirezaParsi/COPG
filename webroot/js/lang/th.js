...
I18N.register('th', {
  ...
  info_androidid_msg: 'ทำให้แอปในโปรไฟล์อุปกรณ์นี้อ่าน ANDROID_ID ปลอม (ตัวระบุจาก Settings.Secure) 16 ตัวอักษรเลขฐานสิบหก ใช้งานได้โดยไม่ต้องรีบูต และโมดูลจะถูกยกเลิกการโหลดก่อนแอปทำงาน จึงไม่มีร่องรอยของ COPG ในหน่วยความจำของแอป เว้นว่างไว้เพื่อใช้ ID จริง หมายเหตุ: แอปที่ตั้งใจยังอ่าน ID จริงด้วยวิธีอื่นได้ — สิ่งนี้เปลี่ยนเฉพาะการค้นหา Settings มาตรฐานเท่านั้น',
