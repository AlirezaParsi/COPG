...
I18N.register('ar', {
  ...
  info_androidid_msg: 'يجعل تطبيقات هذا الملف للجهاز تقرأ ANDROID_ID مزيّفًا (المعرّف من Settings.Secure). ١٦ خانة سداسية. يُطبَّق دون إعادة تشغيل وتُفرَّغ الوحدة قبل تشغيل التطبيق، فلا يبقى أثر من COPG في ذاكرة التطبيق. اتركه فارغًا للإبقاء على المعرّف الحقيقي. ملاحظة: قد يقرأ تطبيق مصمَّم المعرّف الحقيقي بوسائل أخرى — هذا يغيّر فقط بحث Settings القياسي.',
