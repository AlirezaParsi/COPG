...
I18N.register('es', {
  ...
  info_androidid_msg: 'Hace que las apps de este perfil de dispositivo lean un ANDROID_ID falso (el identificador de Settings.Secure). 16 caracteres hex. Se aplica sin reiniciar y el módulo se descarga antes de que la app se ejecute, así no queda nada de COPG en su memoria. Déjalo vacío para mantener el ID real. Nota: una app decidida puede leer el ID real por otros medios — esto solo cambia la consulta estándar de Settings.',
